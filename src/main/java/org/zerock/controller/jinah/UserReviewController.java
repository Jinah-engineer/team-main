...
public class UserReviewController {
	...
	@GetMapping("/list")
	public void reviewList(@ModelAttribute("recri") ReviewCriteria recri, UserReviewVO review, Model model) {
	...
	@GetMapping("/get")
	@PreAuthorize("hasRole('ROLE_ADMIN') or hasRole('ROLE_USER')")
	public void reviewGet(@RequestParam("reBno") int reBno, @ModelAttribute("recri") ReviewCriteria recri,
	...
	@GetMapping("/modify")
	@PreAuthorize("hasRole('ROLE_ADMIN') or hasRole('ROLE_USER')")
	public void reviewModify(@RequestParam("reBno") int reBno, @ModelAttribute("recri") ReviewCriteria recri,
			UserReviewVO review, UserReviewLikersVO likers, Model model) {

		reviewGet(reBno, recri, review, likers, model);

	}

	// 리뷰 파일 수정하기 (기존 이미지 유지) 
	@PostMapping("/maintain")
	@PreAuthorize("hasRole('ROLE_ADMIN') or hasRole('ROLE_USER')")
	public String maintainFile(@RequestParam("reBno") int reBno, @ModelAttribute("recri") ReviewCriteria recri,
			UserReviewVO review, UserReviewLikersVO likers, MultipartFile[] file, Model model,
			RedirectAttributes rttr) {
		;

		boolean success = service.maintainFile(review, file);
	...
	@PostMapping("/modify")
	@PreAuthorize("hasRole('ROLE_ADMIN') or hasRole('ROLE_USER')")
	public String reviewModify(UserReviewVO review, ReviewCriteria recri, MultipartFile[] file,
			RedirectAttributes rttr) {
	...
	@PostMapping("/remove")
	@PreAuthorize("hasRole('ROLE_ADMIN') or hasRole('ROLE_USER')")
	public String reviewRemove(@RequestParam("reBno") int reBno, ReviewCriteria recri, RedirectAttributes rttr,
			String reWriterName) {
